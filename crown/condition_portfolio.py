"""Crown independent-validation portfolio (append-only, simulation-only)."""
...
def evaluate_new_t5(ledger: dict[str, Any], watch: dict[str, Any], config: Settings, *, history_rows: Iterable[dict[str, Any]] | None = None, ranking: Iterable[dict[str, Any]] | None = None) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
