...
def _history_row(watch: dict[str, Any], stage: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "prediction_model": stage.get("prediction_model"),
        "input_policy": stage.get("input_policy"),
        "input_cutoff_at": stage.get("input_cutoff_at"),
        "opening_snapshot_hash": stage.get("opening_snapshot_hash"),
        "opening_model_status": stage.get("opening_model_status"),
        "team_history_as_of": stage.get("team_history_as_of"),
        "team_history_sample": copy.deepcopy(stage.get("team_history_sample")),
        "team_history_features": copy.deepcopy(stage.get("team_history_features")),
        "blend": copy.deepcopy(stage.get("blend")),
        "late_inputs_used": list(stage.get("late_inputs_used") or []),
