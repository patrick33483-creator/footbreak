...
class ResultSourceTests(unittest.TestCase):
    ...
    def test_public_refresh_uses_static_data_instead_of_missing_api_route(self) -> None:
        ...
        self.assertIn("styles.css?v=20260825-data-health-condition-research-footbreak-condition-simulation-wilson-condition-funnel-v2", index)
        self.assertIn("app.js?v=20260825-data-health-condition-research-footbreak-condition-simulation-wilson-condition-funnel-v2", index)
        self.assertNotIn("wilson-pending-forecast-v1", index)
